...
from nnunetv2.training.nnUNetTrainer.variants.loss.nnUNetTrainerInstanceLosses import nnUNetTrainerGlobalCCDiceCE
...
class nnUNetTrainer_2000epochs_LRdecay_CCDiceCE(nnUNetTrainerGlobalCCDiceCE):
    def __init__(
        self,
        plans: dict,
        configuration: str,
        ...
        super(nnUNetTrainer_2000epochs_LRdecay_CCDiceCE, self).__init__(
            plans, configuration, fold, dataset_json, device
        )
        self.num_epochs = 2000
        # self.num_iterations_per_epoch = 250
